...
if (empty($postbac_country)) {
    $errors['postbac_country'] = 'Le champ \'Pays\' ne doit pas être vide.';
...
if (empty($postbac_mention)) {
    $errors['postbac_mention'] = 'Le champ \'Pays\' ne doit pas être vide.';
  ...
  if (empty($uploaded_file)) {
    $errors['userfile'] = 'Le champ \'Votre relevé de notes\' ne doit pas être vide.';
  }
  ...
  if (empty($errors)) {
  	...
  	$query = $db->prepare('INSERT INTO postbac  SET postbac_mention = :postbac_mention, postbac_department = :postbac_department, postbac_country = :postbac_country, postbac_city = :postbac_city, postbac_serie = :postbac_serie, postbac_year = :postbac_year, chemin = :chemin ');
...
<h1>Baccaleaureat ou équivalence</h1>
<form action="" method="POST">
<div class="form1">
<label for="bac_country">Pays <span>*</span></label>
...
<option value="Zimbabwe">Zimbabwe </option>
 ...
 <!--  //////////////////////////////////////////////////////////////////////////////////// !-->
          	...
          	<label for="name">Département<span>*</span></label>
          <input type="text" name="postbac_department"><br>
          <label for="name">Ville<span>*</span></label>
          <input type="text" name="postbac_city"><br>
          <label for="city">Année d'obtention<span>*</span></label>
          <input type="text" name="postbac_year"><br>
          <label for="name">Série<span>*</span></label>
          <input type="text" name="postbac_serie"><br>  

          <label for="mention">Mention<span>*</span></label>
          <select name="postbac_mention">
           <option value=""></option>
           ...
           <br>
            ...
            <label for="acte">relevé des notes<span>*</span></label>
